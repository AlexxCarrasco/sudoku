...
public class Main {
    public static void main(String[] args) {
       ...
       //int [][] matrizSudoku = {{0,0,6,4,3,7,0,1,0},{0,3,1,0,0,5,4,6,7},{0,7,0,0,0,0,0,0,8},{0,2,9,0,0,0,3,0,0},{1,7,8,0,0,0,0,5,0},{3,0,0,0,2,6,0,0,0},{8,0,5,0,0,3,7,9,0},{0,0,4,5,0,9,0,8,6},{9,1,0,0,8,7,0,0,4}};
        ...
        int [][] matrizSudoku = {{5,3,4,0,0,2,1,9,8},{6,7,8,1,9,5,0,4,2},{9,1,2,3,4,8,5,6,7},{8,5,0,4,2,6,7,1,3},{7,6,1,8,5,3,9,0,4},{4,2,3,7,0,1,8,5,6},{9,6,1,2,8,7,3,4,5},{5,3,7,4,1,9,2,8,6},{2,8,4,6,3,5,1,7,9}};
